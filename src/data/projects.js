...
const projects = [
  ...
  {
    title: 'JB ADC Dispute & Reconciliation System',
    subtitle: 'Automated platform for resolving Alternative Delivery Channel ADC transaction discrepancies and financial reconciliation.',
    category: ['Backend Development', 'Frontend Development'],
    technology: ['HTML', 'CSS', 'Bootstrap', 'JQuery', 'Python', 'Django', 'Pip', 'Oracle', 'Procedures', 'Oracle', 'MVT', 'SQLite3'],
    link: '',
    image: '/images/projects/ejms.png',
    date: '2025-12-15',
    workedfor: 'Janata Bank PLC.',
    workedurl: 'https://www.jb.com.bd/',
    desc:
      'A comprehensive banking solution designed to manage and resolve Alternative Delivery Channel (ADC) disputes. The system automates the reconciliation of digital transactions, identifies failed or mismatched records, and facilitates dispute lifecycle management. Key modules include user and role-based access control, EFT management, loan/credit system integration, and advanced transaction reporting to ensure financial accuracy and operational efficiency.',
  },
  // {
  //   title: 'Rab',
  ...
  //   category: ['Frontend Development'],
  //   technology: ['HTML', 'CSS', 'Javascript', 'Node.js', 'React', 'JSX', 'useState', 'SCSS'],
